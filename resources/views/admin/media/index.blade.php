            ...
            <div class="box-body">
              ...
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td>
                    @if($media->author_img == 'No image found')
                        <img src="/assets/admin/dist/img/no-img.png" width="100" height="100" class="img-thumbnail" alt="No img found">
                    @else
                        <img src="/uploads/{{ $media->author_img }}" width="100" height="100" class="img-thumbnail" alt="{{ $media->title }}">
                    @endif
                  </td>
                  <td>
